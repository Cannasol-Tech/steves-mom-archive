...
class GeneratedTask(BaseModel):
    ...
    estimated_duration_minutes: Optional[int] = Field(None, ge=1, le=10080)  # Max 1 week
...
class DocumentRequest(BaseModel):
    ...
    classification_level: Literal["public", "internal", "confidential", "secret", "top_secret"] = "internal"


class DatabaseQuery(BaseModel):
    """Structured database query request with safety validation."""
    query_type: Literal["select", "count", "aggregate"] = "select"  # Only safe operations
