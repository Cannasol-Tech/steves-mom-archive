...
class FeatureRegistry:
    ...
    def _load_default_features(self):
        ...
        self.register_feature(FeatureInfo(
            feature_id="FR-1.1",
    ...
    def is_implemented(self, feature_id: str) -> bool:
        ...
        return feature and feature.status == ImplementationStatus.IMPLEMENTED
    ...
    def get_implemented_features(self) -> Set[str]:
        ...
        return {
            fid for fid, feature in self.features.items()
    ...
    def get_status_summary(self) -> Dict[str, int]:
        ...
        for status in ImplementationStatus:
            summary[status.value] = sum(
                1 for feature in self.features.values()
