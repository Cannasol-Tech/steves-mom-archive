...
async def test_steves_mom_chat():
    ...
    try:
        # Create Steve's Mom
        steves_mom = create_supreme_overlord(enable_tools=False)  # Disable tools for simple test
        ...
        return {
            ...
            "personality_detected": "supreme" in response.content.lower() or "overlord" in response.content.lower()
        }
